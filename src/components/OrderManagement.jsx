...
//   map the data to columns | note:- order matters*
  ...
  return (
      <div className='flex flex-col gap-[2.5rem] bg-white p-[2rem] rounded-[1rem]'>
        <h1 className='text-text text-[1.5rem] font-[600] tracking-[0.07813rem]'>Order Management &gt; Table</h1>
        <Table columns={columns} data={data} mapping={mapping} fun={setNewOrder} />
        {newOrder && <NewOrderModal onClose={setNewOrder} />}
      </div>
  )
}
